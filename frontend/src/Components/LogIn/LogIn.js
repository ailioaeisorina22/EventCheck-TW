...
const Login = () => {
  ...
  return (
    <div className="d-flex justify-content-center">
      <div className="card custom-card1 col-sm-10 col-md-8 col-lg-6 ">
        <h1 className="custom-heading d-flex justify-content-center ">EventCheck Login</h1>
        <form onSubmit={SignInHandleSubmit}>
          ...
          <div className="d-flex justify-content-center">
            <button className="custom-button col-11 mt-2" type="submit" style={{ backgroundColor: '#9b1414' }}>
              Login
            </button>
          </div>
